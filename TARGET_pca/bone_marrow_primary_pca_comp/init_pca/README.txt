...
This directory (init_pca) performs MDS analysis of TARGET-ALL-P2
...
Step 1: Load data
Voom transformed data is loaded. Table containing information (subtype, year of diagnosis, 
tissue portion, and number isolation from aliquot) about samples is also loaded. 

Step 2: Perform MDS analysis
MDS analysis of voom transformed data is performed coloring for subtype, year of diagnosis, 
tissue portion, and number isolation from aliquot. Plots are also created where the MDS
plot of subtype is side by side with MDS plots of each of the three variables 
(year of diagnosis, tissue portion, and number isolation from aliquot). Plots are saved. 
...
TARGET_ALL_P2_bmp_pca_comp.R is the script that should be run. This script sources the
functions script TARGET_ALL_P2_bmp_pca_functions.R. 

TARGET_ALL_P2_bmp_pca_comp.R should be run in the following way from the terminal:
Rscript TARGET_pca/bone_marrow_primary_pca_comp/init_pca/TARGET_ALL_P2_bmp_pca_comp.R


* OUTPUT * 

./ALL_P2_bmp_subtype_MDS_init.pdf
- MDS plot coloring for subtypes from step 2 of * PROCESS IN THE SCRIPT *

./ALL_P2_bmp_year_MDS_init.pdf
- MDS plot coloring for year of diagnosis from step 2 of * PROCESS IN THE SCRIPT *

./ALL_P2_bmp_portion_MDS_init.pdf
- MDS plot coloring for tissue portion from step 2 of * PROCESS IN THE SCRIPT *

./ALL_P2_bmp_isolation_MDS_init.pdf
- MDS plot coloring for number isolation from step 2 of * PROCESS IN THE SCRIPT *

./ALL_P2_bmp_subtype_year_MDS_init.pdf
- MDS plots coloring for subtype and year of diagnosis side by side from step
  2 of * PROCESS IN THE SCRIPT *

./ALL_P2_bmp_subtype_portion_MDS_init.pdf
- MDS plots coloring for subtype and tissue portion side by side from step 2 of
  * PROCESS IN THE SCRIPT *

./ALL_P2_bmp_subtype_isolation_MDS_init.pdf
