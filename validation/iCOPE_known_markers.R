...
known_markers_exp <- voom_filt_data$E[which(rownames(voom_filt_data$E) %in% known_markers), ]
...
write_csv(matrix_melt, file = "known_markers/iCOPE_corr_known_markers_mat.csv")

# Save correlation heatmap
ggsave(filename = "iCOPE_corr_known_markers_heatmap.pdf", 
       plot = cor_heatmap, 
       path = "known_markers/", 
       width = 5, 
       height = 4)
